...
function setup() {
  ...
  students = ['Grid View', 'About codeWords', 'Yutang Mu', 'Roby Manlongat', 'Bridie O\'Toole', 'Ruby Brown', 'Taj Healy', 'Natasha Nathania', 'Jamie Tung', 'Fergus Arundel', 'Celia Mance', 'House of Leaves', 'Kristine Gudmundsen', 'Samantha Ng', 'ZIYUN YUAN', 'Thomas Bellamy', 'Hamish Payne', 'Jackie Liu', 'Finn Arundel', 'Lai Unian', 'Napasorn Chotnoparatpat', 'Amy Ledger', 'Win(Siyang) Wen ', 'Tayla Rogic', 'Lauren Tan', 'Chen Faye', 'Peem Thaugsuban', 'Zhongrui Feng'];  
