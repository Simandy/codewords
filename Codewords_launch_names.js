...
function setup() {
  ...
  students = ['Grid View', 'About codeWords', 'Yutang Mu', 'Roby Manlongat', 'Bridie O\'Toole', 'Ruby Brown', 'Taj Healy', 'Natasha Nathania', 'Jamie Tung', 'Fergus Arundel', 'Celia Mance', 'House of Leaves', 'Kristine Gudmundsen', 'Samantha Ng', 'Ziyun Yuan', 'Thomas Bellamy', 'Hamish Payne', 'Jackie Liu', 'Finn Arundel', 'Lai Unian', 'Napasorn Chotnoparatpat', 'Amy Ledger', 'Win(Siyang) Wen ', 'Tayla Rogic', 'Lauren Tan', 'Faye Chen', 'Peem Thaugsuban', 'Zhongrui Feng'];  
